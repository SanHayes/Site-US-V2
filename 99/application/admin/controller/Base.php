...
class Base extends Controller
{
    public function __construct(){
		...
		*/
        ...
        $amount_name_admin = db('config')->field('value')->where(['name'=>'amount_name_admin'])->find();
        
        $this->assign('amount_name_admin',$amount_name_admin['value']);
	...
	protected function fetch($template = '', $vars = [], $replace = [], $config = [])
    {
		...
		$replace['__BOOTSTRAP__'] = str_replace('/index.php','',\think\Request::instance()->root()).'/static/bootstrap';
